      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/election/libcompat-v10.5.5.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/election/libnocompat-v10.5.5.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/election/libnocompat-v10.5.5.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/election/lib-v10.5.5.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentConfig-v10.5.5.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentThemes-v10.5.5.js"></script>'},
            {selector:'body',html:'<script src="/election/app-v10.5.5.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentPlugins-v10.5.5.js"></script>'},

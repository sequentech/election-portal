      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/election/libcompat-v6.1.2.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/election/libnocompat-v6.1.2.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/election/libnocompat-v6.1.2.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/election/lib-v6.1.2.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentConfig-v6.1.2.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentThemes-v6.1.2.js"></script>'},
            {selector:'body',html:'<script src="/election/app-v6.1.2.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentPlugins-v6.1.2.js"></script>'},

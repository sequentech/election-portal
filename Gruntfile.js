      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/election/libcompat-v4.0.0-beta.1.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/election/libnocompat-v4.0.0-beta.1.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/election/libnocompat-v4.0.0-beta.1.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/election/lib-v4.0.0-beta.1.min.js"></script>'},
            {selector:'body',html:'<script src="/election/avConfig-v4.0.0-beta.1.js"></script>'},
            {selector:'body',html:'<script src="/election/avThemes-v4.0.0-beta.1.js"></script>'},
            {selector:'body',html:'<script src="/election/app-v4.0.0-beta.1.min.js"></script>'},
            {selector:'body',html:'<script src="/election/avPlugins-v4.0.0-beta.1.js"></script>'},

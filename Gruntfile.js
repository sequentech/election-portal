      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/election/libcompat-v5.1.1.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/election/libnocompat-v5.1.1.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/election/libnocompat-v5.1.1.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/election/lib-v5.1.1.min.js"></script>'},
            {selector:'body',html:'<script src="/election/avConfig-v5.1.1.js"></script>'},
            {selector:'body',html:'<script src="/election/avThemes-v5.1.1.js"></script>'},
            {selector:'body',html:'<script src="/election/app-v5.1.1.min.js"></script>'},
            {selector:'body',html:'<script src="/election/avPlugins-v5.1.1.js"></script>'},

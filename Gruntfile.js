      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/election/lib-v7.3.0.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentConfig-v7.3.0.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentThemes-v7.3.0.js"></script>'},
            {selector:'body',html:'<script src="/election/app-v7.3.0.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentPlugins-v7.3.0.js"></script>'},

      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/election/libcompat-v9.1.0.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/election/libnocompat-v9.1.0.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/election/libnocompat-v9.1.0.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/election/lib-v9.1.0.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentConfig-v9.1.0.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentThemes-v9.1.0.js"></script>'},
            {selector:'body',html:'<script src="/election/app-v9.1.0.min.js"></script>'},
            {selector:'body',html:'<script src="/election/SequentPlugins-v9.1.0.js"></script>'},
